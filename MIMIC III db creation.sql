CREATE DATABASE IF NOT EXISTS mimic_iii_project;
...
CREATE TABLE CPTEVENTS (	
   ...
   CPT_NUMBER int UNSIGNED,
   CPT_SUFFIX VARCHAR(5),	
   TICKET_ID_SEQ int UNSIGNED,
...
CREATE TABLE D_CPT (	
   ...
   MINCODEINSUBSECTION int UNSIGNED NOT NULL,
   MAXCODEINSUBSECTION int UNSIGNED NOT NULL,
...
CREATE TABLE ICUSTAYS (
   ...
   SUBJECT_ID int UNSIGNED NOT NULL,
   HADM_ID int UNSIGNED NOT NULL,
   ICUSTAY_ID int UNSIGNED NOT NULL,
   DBSOURCE VARCHAR(20) NOT NULL,
...
CREATE TABLE INPUTEVENTS_CV (
   ...
   LINKORDERID int UNSIGNED NOT NULL,
   STOPPED VARCHAR(30),	
...
CREATE TABLE MICROBIOLOGYEVENTS (
   ...
   CHARTTIME DATETIME,
   SPEC_ITEMID int UNSIGNED,
   SPEC_TYPE_DESC VARCHAR(100) NOT NULL,
   ORG_ITEMID int UNSIGNED,
   ORG_NAME VARCHAR(100),	
   ISOLATE_NUM TINYINT UNSIGNED,
   AB_ITEMID int UNSIGNED,
   AB_NAME VARCHAR(30),	
   DILUTION_TEXT VARCHAR(10),
   DILUTION_COMPARISON VARCHAR(20),
   DILUTION_VALUE int UNSIGNED,
